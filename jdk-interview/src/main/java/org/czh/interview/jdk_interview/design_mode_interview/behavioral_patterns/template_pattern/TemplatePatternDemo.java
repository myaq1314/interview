package org.czh.interview.jdk_interview.design_mode_interview.behavioral_patterns.template_pattern;
...
public class TemplatePatternDemo {
    ...
    public static void main(String[] args) {
        StudyAbroadTemplate abroadAmerica = new StudyAbroadTemplate.StudyInAmerica();
        abroadAmerica.studyAbroad();
        System.out.println();

        StudyAbroadTemplate abroadEnglish = new StudyAbroadTemplate.StudyInEnglish();
        abroadEnglish.studyAbroad();
        System.out.println();
    }

    // 抽象类:出国留学
    abstract static class StudyAbroadTemplate {
        ...
        // 是否健康 钩子方法，子类决定父类
        public abstract boolean isNotHealth();

        // 告知，具体方法，
        public void ask() {
            System.out.println("告知：");
            System.out.println("如果你身体不好，在外国容易受欺负，请注意保护好自己");
        }
        ...
        // 具体子类 美国留学
        static class StudyInAmerica extends StudyAbroadTemplate {
            @Override
            ...
            public void arriving() {
                ...
                System.out.println("  1）安排住宿；");
                System.out.println("  2）了解校园及周边环境。");
                System.out.println("  3）购买好防身枪支。");
                System.out.println("  4）晚间二十二点之后不要出门。");
            }
        }

        // 具体子类 英国留学
        static class StudyInEnglish extends StudyAbroadTemplate {
            @Override
            public boolean isNotHealth() {
                return true;
            }
            ...
            public void readyGoAbroad() {
                ...
                System.out.println("  1）进行身体检查、免疫检查和接种传染病疫苗；");
                System.out.println("  2）确定机票时间、航班和转机地点。");
                System.out.println("  3）准备一下呼吸性药品，英国是雾都，对呼吸不好的乘客有影响。");
            }
        }
    }
}
