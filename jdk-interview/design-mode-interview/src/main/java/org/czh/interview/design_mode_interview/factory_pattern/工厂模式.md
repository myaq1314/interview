...
public class AoDiCar implements Car {
    ...
    public void travel() { // 旅游
        System.out.println("开奥迪车去旅游，120km/h");
    }

    @Override
    public void transport() {  // 运输
        System.out.println("开奥迪车搞运输，大材小用");
    }
}
```

创建一个 时风四轮拉货车，实现 汽车接口

```java
public class ShiFengCar implements Car {
    @Override
    public void travel() { // 旅游
        System.out.println("开时风四轮拉货车去旅游，60km/h");
    }
