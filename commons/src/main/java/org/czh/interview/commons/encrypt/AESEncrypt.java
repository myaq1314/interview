...
public final class AESEncrypt {
    ...
    public static void main(String[] args) {
        ...
        EncryptKeyUtil.writeKey(EncryptConstant.getAES(), key);

        String key2 = EncryptKeyUtil.readLastKey();
        System.out.println(key2); // YHZcwVrucOTSQ+W2wXZhLA==
    ...
    public static byte[] encode(@NotEmptyTag byte[] srcBytes, @NotNullTag SecretKey secretKey) {
        ...
        try {
            Cipher cipher = EncryptUtil.getAESCipher(Cipher.ENCRYPT_MODE, secretKey);
    ...
    public static byte[] decode(@NotEmptyTag byte[] dstBytes, @NotNullTag SecretKey secretKey) {
        ...
        try {
            Cipher cipher = EncryptUtil.getAESCipher(Cipher.DECRYPT_MODE, secretKey);
