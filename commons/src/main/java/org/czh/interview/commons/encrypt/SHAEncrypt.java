...
public final class SHAEncrypt {
    ...
    public static void main(String[] args) {
        ...
        EncryptKeyUtil.writeKey(EncryptConstant.SHAType.SHA_1.key, salt);

        String salt2 = EncryptKeyUtil.readLastKey();
        System.out.println(salt2); // 844f77f9196859d501819313881b5e2c
        EqualsAssert.isEquals(salt, salt2);

        String src = "123456";
        System.out.println(src); // 123456

        String dst1 = encode(EncryptConstant.SHAType.SHA_1, src, salt2);
        String dst12 = encode(EncryptConstant.SHAType.SHA_1, src, salt2);
        System.out.println(dst1); // b1733f92e9372c4c33b7544e210ea6004a93033e
        FlagAssert.isTrue(verify(EncryptConstant.SHAType.SHA_1, src, dst1, salt2));
        EqualsAssert.isEquals(dst1, dst12);

        String dst224 = encode(EncryptConstant.SHAType.SHA_224, src, salt2);
        String dst2242 = encode(EncryptConstant.SHAType.SHA_224, src, salt2);
        System.out.println(dst224); // 2b6db796983488d24bd5da59ff1a89ab822e75b9cb11f8a9fb55f14f
        FlagAssert.isTrue(verify(EncryptConstant.SHAType.SHA_224, src, dst224, salt2));
        EqualsAssert.isEquals(dst224, dst2242);

        String dst256 = encode(EncryptConstant.SHAType.SHA_256, src, salt2);
        String dst2562 = encode(EncryptConstant.SHAType.SHA_256, src, salt2);
        System.out.println(dst256); // 1184305bdf1e454a12d6cacbfe200bbf0e6ff47271a466bc5f0dfc057ed977be
        FlagAssert.isTrue(verify(EncryptConstant.SHAType.SHA_256, src, dst256, salt2));
        EqualsAssert.isEquals(dst256, dst2562);

        String dst384 = encode(EncryptConstant.SHAType.SHA_384, src, salt2);
        String dst3842 = encode(EncryptConstant.SHAType.SHA_384, src, salt2);
        ...
        FlagAssert.isTrue(verify(EncryptConstant.SHAType.SHA_384, src, dst384, salt2));
        EqualsAssert.isEquals(dst384, dst3842);

        String dst512 = encode(EncryptConstant.SHAType.SHA_512, src, salt2);
        String dst5122 = encode(EncryptConstant.SHAType.SHA_512, src, salt2);
        ...
        FlagAssert.isTrue(verify(EncryptConstant.SHAType.SHA_512, src, dst512, salt2));
    ...
    public static String encode(@NotNullTag EncryptConstant.SHAType shaType, @NotBlankTag String src, String salt) {
        ...
        MessageDigest shaMd = EncryptUtil.getSHA(shaType);
        return dstArrayToString(shaMd.digest(srcBytes));
    }
